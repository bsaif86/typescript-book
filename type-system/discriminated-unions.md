...
If you have a class with a [_literal member_](literal-types.md) then you can use that property to discriminate between union members.
...
Here is the [_gist of redux_](https://github.com/reactjs/redux#the-gist) with TypeScript type annotations added:
